          		...
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="nombre_servicio" value="<?php echo $this->input->post('nombre_servicio'); ?>" class="form-control" id="nombre_servicio" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="precio_s" value="<?php echo $this->input->post('precio_s'); ?>" class="form-control" id="precio_s" />
						</div>
					</div>
					<div class="col-md-6">
